module.exports = function(grunt) {
  ...
  grunt.initConfig({
	...
	uglify: {
	  options: {
		banner: '/*! Explore prototype-V1 <%= grunt.template.today("yyyy-mm-dd") %> */\n'		// Change to application specific name
	  },
	  frameworksdebug: {
		options: {
			beautify:true
		...
		dest: '../../debug/js/prototype-V1/frameworks.js'
	  },
	  frameworks: {
		src: [
			'../../js/library/modernizr.js',
		...
		dest: '../../production/js/prototype-V1/frameworks.js'
	  },
	  applicationdebug: {
		options: {
			beautify:true
		...
		dest: '../../debug/js/prototype-V1/application.js'		// Change to application specific directory
	  },
	  application: {
		src: [
			'bower_components/foundation/js/foundation/foundation.js',
		...
		dest: '../../production/js/prototype-V1/application.js'		// Change to application specific directory
	  }
	},
	compass: {
		development: {
	...
	stencil: {
		main: { // task target name
		  ...
		  files: [{
			...
			cwd: 'pages/',
			src: '**/*.dot.html',
			dest: '../../html/prototype-V1',				// Change to application specific directory
			ext: '.html'
		  }]
		}
	},
